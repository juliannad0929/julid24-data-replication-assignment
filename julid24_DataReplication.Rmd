...
```{r}
subway_use <- read.csv("1._Cross-sectional_COVID19_mobility_zcta.csv", stringsAsFactors = TRUE)
head(subway_use)
```

## Calculate the Mean and IQR
> The mean standardized change in subway use from baseline to Aprill 11 among all ZCTAs was -20.96 (IQR: -25.57 to -16.05).
