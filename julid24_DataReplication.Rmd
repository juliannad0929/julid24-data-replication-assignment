...
## Import the Dataset
Please download the following datasets from my repository folder "Sy open data": 
...
<img src="julid24-data-replication-assignment/95 Conf Int data rep.png" width="100px"/>
...
```{r}
regression_output <- read.csv("Sy open data/5._Regression_output.csv", stringsAsFactors = TRUE)
...
<img src="julid24-data-replication-assignment/Figure 4 data rep.png" width="100px"/>
