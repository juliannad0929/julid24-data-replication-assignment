...
## Import the Dataset
```{r}
a <- curl("https://raw.githubusercontent.com/juliannad0929/julid24-data-replication-assignment/main/Sy%20open%20data/5._Regression_output.csv")
table <- read.csv(a, header=TRUE, stringsAsFactors = TRUE)
head(table)
```
